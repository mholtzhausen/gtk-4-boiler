//! EmptyState Demo page — shows the empty state placeholder component.

use gtk4::prelude::*;

/// Build the empty state demo page.
pub fn create() -> gtk4::Box {
    ...
    let label = gtk4::Label::new(Some("Empty state demo — coming soon."));
