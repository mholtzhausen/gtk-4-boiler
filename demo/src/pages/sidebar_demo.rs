//! Sidebar Demo page — shows an embedded sidebar (not the app shell's).

use gtk4::prelude::*;

/// Build the sidebar demo page.
pub fn create() -> gtk4::Box {
    ...
    let label = gtk4::Label::new(Some("Embedded sidebar demo — coming soon."));
