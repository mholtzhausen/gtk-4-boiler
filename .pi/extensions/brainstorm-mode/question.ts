 ...
 * Copied from the official pi example and embedded here so brainstorm-mode
 * is self-contained (no external imports needed).
 *
 * The LLM calls this tool to ask the user a question interactively.
 * Presents an option list with ↑↓ navigate, Enter select, and a
 * "Type something." free-form option.
 */
...
const QuestionParams = Type.Object({
	...
	options: Type.Array(OptionSchema, {
		description: "Options for the user to choose from. Include clear options the user can pick.",
	}),
});
...
export function registerQuestionTool(pi: ExtensionAPI): void {
	pi.registerTool({
		...
		description:
			...
			"Use this tool whenever you need user input, a decision, a preference, " +
			"or a clarification. Do NOT output text questions — call this tool instead.",
